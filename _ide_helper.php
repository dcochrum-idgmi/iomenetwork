 ...
 * Generated for Laravel 5.0.14 on 2015-03-19.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Iome\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Iome\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Iome\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Iome\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Iome\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Iome\Console\Kernel::output();
        }
    ...
    class Nebula extends \Iome\Macate\Nebula\Nebula{
         ...
         * @static 
         */
        public static function getAll($module, $filters = array()){
            return \Iome\Macate\Nebula\NebulaAPI::getAll($module, $filters);
        }
         ...
         * @static 
         */
        public static function officeCreate($parameters){
            return \Iome\Macate\Nebula\NebulaAPI::officeCreate($parameters);
        }
         ...
         * @static 
         */
        public static function officeUpdate($parameters){
            return \Iome\Macate\Nebula\NebulaAPI::officeUpdate($parameters);
        }
         ...
         * @static 
         */
        public static function getOffice($value, $field = 'officeId'){
            return \Iome\Macate\Nebula\NebulaAPI::getOffice($value, $field);
        }
