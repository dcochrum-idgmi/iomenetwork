...
namespace {
    ...
    class Extension extends \Iome\Extension{
    ...
    class Nebula extends \Iome\Macate\Nebula\Facade{
         ...
         * @static 
         */
        public static function populateModel($module, $data = array(), $sync_original = false){
            return \Iome\Macate\Nebula\API::populateModel($module, $data, $sync_original);
        }
    ...
    class Organization extends \Iome\Organization{
