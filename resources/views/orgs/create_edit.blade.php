...
@endif
	<div class="form-group{!! $errors->has('name') ? ' has-error' : '' !!}">
		{!! Form::label('name', trans('orgs.name'), ['class' =>'col-md-2 control-label']) !!}
		<div class="col-md-10">
			{!! Form::text('name', null, ['class' =>'form-control', 'placeholder' => trans('orgs.name-ph')]) !!}
			{!! $errors->first('name', Form::label('name', ':message', ['class' => 'error'])) !!}
		</div>
	</div>
